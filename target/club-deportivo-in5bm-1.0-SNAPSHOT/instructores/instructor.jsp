         ...
         <div class="bgded overlay padtop" style="background-image:url();"> 
            ...
            <header id="header" class="hoc clear">
                <div id="logo" class="fl_left"> 
                    ...
                    <h1><a href="../index.html">Instructores</a></h1>
                ...
                <nav id="mainav" class="fl_right"> 
                    ...
                    <ul class="clear">
                        ...
                        <li><a class="drop" href="#">Acerca De Nosotros</a>
                            ...
                            <li><a href="instructor.jsp">Instructores</a></li>
        ...
        <div class="wrapper row3">
            <main class="hoc container clear"> 
                ...
                <div class="content three_quarter first"> 
                    ...
                    <img class="imgr borderedbox inspace-5" src="../assets/images/entrenador1.png" alt="">
                    <p>Tenemos a los mejores entrenadores del mundo, son autenticas leyendas en su deporte, cada uno esta especializado en su area y creanme cuando les digo que son los mejores, son los mejores</p>


                    <p>Sus hijos estaran rodeados de autenticos Profesionales, cada uno de ellos estan totalmente comprometidos con el club 
                        y de la mano de ellos sus hijos se pueden convertir en autenticos Cracks.
                    </p>

                    <div id="comments">
                        <h2>Comentarios de algunos de nuestros ex jugadores a cerca de sus entrenadores</h2>
                        <ul>
                            <li>
                                <article>
                                    <header>
                                        ...
                                        <address>
                                            By <a href="#">Julio Iglesias</a>
                                        </address>
                                        <time datetime="2045-04-06T08:15+00:00">Viernes, 6<sup>th</sup> abril 2015 @08:15:00</time>
                                    </header>
                                    <div class="comcont">
                                        <p>Son unas Bestias, son disciplinados y me enseñaron mucho, estoy agradecido con ellos</p>
                                    </div>
                                </article>
                            </li>
                            <li>
                                <article>
                                    ...
                                    <div class="comcont">
                                        <p>Tienen mucha pasciensia, a mi me costaba mucho al principio pero ellos me apoyaron en todo sentido</p>
                                    </div>
                                </article>
                            </li>
